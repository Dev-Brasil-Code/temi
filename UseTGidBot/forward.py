...
async def forwarded(bot, msg):
    if msg.forward_from:
        ...
        if hidden:
            await msg.reply(
                f"Avanço detectado, mas, infelizmente, {hidden} ativou a privacidade de encaminhamento, então não consigo obter a id deles",
                quote=True,
            )
        else:
            text = f"Avanço detectado. \n\n"
